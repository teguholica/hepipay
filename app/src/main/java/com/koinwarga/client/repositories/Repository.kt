package com.koinwarga.client.repositories

import android.content.Context
import com.koinwarga.client.datasources.local_database.LocalDatabase
    ...
    suspend fun createAccount(asDefault: Boolean = false): Account =
        withContext(scope.coroutineContext + Dispatchers.IO) {
            ...
            db.accountDao().insertAll(
                com.koinwarga.client.datasources.local_database.Account(
